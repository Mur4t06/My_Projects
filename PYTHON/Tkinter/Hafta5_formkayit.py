...
ana_frame = tk.Frame(form, bg='green')
ana_frame.pack()


kullanici_bilgileri_frame = tk.LabelFrame(ana_frame, text="Kullanıcı Bilgileri", bg='red')
...
kayit_bilgileri_frame = tk.LabelFrame(ana_frame, text="Kayıt Bilgleri", bg='yellow')
...
spn_sinif = tk.Spinbox(kayit_bilgileri_frame, from_=0, to="infinity")
